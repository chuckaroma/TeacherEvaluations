...
-(IBAction)saveAssessmentData:(id)sender {
...
-(IBAction)loadAssessmentData:(id)sender {
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
...
- (void)viewDidLoad
{
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"Jupiter.jpg"]];
    [super viewDidLoad];
